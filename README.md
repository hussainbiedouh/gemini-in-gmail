...
A Chrome extension that integrates Google Gemini AI directly into Gmail to help you compose, reply, and refine emails with AI-powered assistance.
...
5. Click the extension icon in the toolbar to open the options page
